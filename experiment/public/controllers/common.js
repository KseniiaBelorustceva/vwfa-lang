...
myApp.controller('AppCtrl', ['$scope', '$http','$location', 
	...
	function($scope, $http, $location){
		...
		$scope.addParticipant = function(){
			//console.log("in addParticipant(): " + $scope.participant);
			//console.log("in addParticipant()  $scope.particID yet: " +  $scope.particID);	
			$http.post('/participate', $scope.participant)
				...
				//.error(function(response){ // error-promise
				//	console.log("error-response from addParticipant():" + response)
				//}))
				;	
